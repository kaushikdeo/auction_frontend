...
const bowlingImage =
  "https://res.cloudinary.com/dfrmnqtwi/image/upload/v1707063350/auctions/xdlivgwq8udlncjnpv3p.png";
const battingImage =
  "https://res.cloudinary.com/dfrmnqtwi/image/upload/v1707063349/auctions/lrq4gchrvldhl2827o4d.png";

const PlayerProfileCard = ({ selectedPlayer, showStats }) => {
  console.log("jasnxjjahhahaa", selectedPlayer, showStats);
        ...
        <div className="profile-card js-profile-card">
              ...
              <Image
                src={
                  selectedPlayer?.imageUrl
                    ? selectedPlayer?.imageUrl
                    : selectedPlayer.playerType === "Batsman"
                    ? battingImage
                    : bowlingImage
                }
                alt="Lamp"
          ...
          <div className="profile-card__cnt js-profile-cnt">
            ...
            <div className="profile-card-inf">
              <div className="profile-card-inf__item">
                <div className="profile-card-inf__title">
                  {selectedPlayer.stats.battingStats.innings}
                </div>
                <div className="profile-card-inf__txt">Innings</div>
              </div>
              <div className="profile-card-inf__item">
                <div className="profile-card-inf__title">
                  {selectedPlayer.stats.battingStats.runs}
                </div>
              ...
              <div className="profile-card-inf__item">
                <div className="profile-card-inf__title">
                  {Math.round(
                    Number(selectedPlayer.stats.battingStats.strikeRate)
                  )}
                </div>
            ...
            <div className="profile-card-inf">
              <div className="profile-card-inf__item">
                <div className="profile-card-inf__title">
                  {selectedPlayer.stats.bowlingStats.overs}
                </div>
                <div className="profile-card-inf__txt">Overs</div>
              </div>
              <div className="profile-card-inf__item">
                <div className="profile-card-inf__title">
                  {selectedPlayer.stats.bowlingStats.wickets}
                </div>
                <div className="profile-card-inf__txt">Wickets</div>
              </div>
              <div className="profile-card-inf__item">
                <div className="profile-card-inf__title">
                  {Number(selectedPlayer.stats.bowlingStats.economy).toFixed(2)}
                </div>
      ...
      <>
        ...
        >
          <a
            ...
            target="_blank"
          >
            <h4>Waiting For Auctioneer</h4>
            <h4>To Select A New Player</h4>
            <h4>...</h4>
